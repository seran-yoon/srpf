...
@WebServlet({"*.do", "/main","/NaverCallback", "/admin"})
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//service메소드는 doPost와 doGet을 모두 처리합니다.
			...
			// 게시물 수정
				...
				MultipartRequest multi = new MultipartRequest(request, "/home/hosting_users/rladudrl286/tomcat/webapps/doArtShow/" + saveFolder, fileSize, "UTF-8", new DefaultFileRenamePolicy());
