...
public class BuyDataBean {
	...
	public String toString() {
		return "BuyDBBean [buy_id=" + buy_id + ", buyer=" + buyer + ", book_id=" + book_id + ", book_title="
				+ book_title + ", buy_price=" + buy_price + ", buy_count=" + buy_count + ", book_image=" + book_image
				+ ", buy_date=" + buy_date + ", account=" + account + ", deliveryName=" + deliveryName
				+ ", deliveryTel=" + deliveryTel + ", deliveryAddress=" + deliveryAddress + ", sanction=" + sanction
				+ "]";
	}
